...
jQuery(document).ready(function($){
    ...
    this.conf = {
      ...
      weekday: {
        timeline: {
          ...
          heightPx: (Args.weekday) ? (Args.weekday.timeline) ? (Args.weekday.timeline.heightPx) ? Args.weekday.timeline.heightPx : 100 : 100 : 100,
      ...
      colors: {
        ...
        random: (Args.colors) ? (Args.colors.random) ? Args.colors.random : false : false
      },
      categories: {
  ...
  Calendar.prototype.drawModal = function() {
    ...
    modal+= '<button type="submit" class="finished"><span>Finished</span></button>';
  ...
  Calendar.prototype.getEventCategoryColor = function(category) {
    return this.getCategoryColor(category, this.eventCategoryColor, this.conf.colors.events, '#13527c');
  };
